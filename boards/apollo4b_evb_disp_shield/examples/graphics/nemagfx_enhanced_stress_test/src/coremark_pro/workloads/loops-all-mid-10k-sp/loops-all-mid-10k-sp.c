...
const uint32_t ui32LoadFlag = 0xdeadbeef;
...
//Porting:We link all the workload together, so we should rename the main function.
void loops_all_mid_10k_sp_main(int argc, char *argv[])
{
