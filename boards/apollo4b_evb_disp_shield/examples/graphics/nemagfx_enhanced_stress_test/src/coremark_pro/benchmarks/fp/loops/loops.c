...
extern void init_preset_0_1k();
extern void init_preset_1_10k();
extern void init_preset_2_100k();
extern void init_preset_3_100();
extern void init_preset_4_32();
extern void init_preset_5_10kdot();
...
e_fp pic_2d(loops_params *p) {
   ...
   /*
    ...
    for ( l=1 ; l<=loop ; l++ ) {
        for ( ip=0 ; ip<n ; ip++ ) {
#if 1   // Ambiq update to resolve compiler warnings "implicit conversion from
        // floating point to integer" by simply supplying casts to (int) in 4 places.
            i1 = (int)p1r[ip];
            j1 = (int)p1i[ip];
            i1 &= 0x03f;
            j1 &= 0x03f;
