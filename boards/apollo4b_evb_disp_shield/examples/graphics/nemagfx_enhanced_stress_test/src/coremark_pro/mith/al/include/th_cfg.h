...
#else
/** EEMBC member company name */
#define EEMBC_MEMBER_COMPANY   "AMBIQ"
/** Processor or DSP name. */
#define EEMBC_PROCESSOR        "APOLLO4P"
/** Name of Target System/Processor description. */
#define EEMBC_TARGET           "32 Bit"
#endif
...
//We don't need this because the memory management APIs in freertos is aligned to 8, witch is same as the ALIGN_BOUNDARY 
#define NO_ALIGNED_ALLOC



//#if defined( NO_ALIGNED_ALLOC )
//#define malloc_aligned(size, align) pvPortMalloc_psram(size)
//#define free_aligned(base) vPortFree_psram(base)
//#else
//#if _MSC_VER
...
#define HEAP_SIZE	(1024*1024*1)	/* 4 Mb */
#endif
...
// sdt_in and std_out are not used, std_err was used to print error information so we have just simply mapped it to al_printf
#endif
...
//Note: The stack size is in unit of word, and should not exceed 64K.
#define PTHREAD_DEFAULT_STACK_SIZE (1*1024)
//This stack size is only for parser_125k workload, it uses recursive functions
#define PTHREAD_BIG_STACK_SIZE (32*1024)
#define PTHREAD_DEFAULT_PRIORITY (4)
